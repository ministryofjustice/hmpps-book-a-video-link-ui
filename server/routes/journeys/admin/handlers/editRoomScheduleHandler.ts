...
import { dateToSimpleTime, getDaysOfWeek, simpleTimeToDate } from '../../../../utils/utils'
...
import { AmendRoomScheduleRequest, Location, RoomSchedule } from '../../../../@types/bookAVideoLinkApi/types'
...
export default class EditRoomScheduleHandler implements PageHandler {
  ...
  GET = async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (room) {
      ...
      const editValues = this.convertScheduleToDisplayFormat(schedule)
  ...
  public POST = async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (room) {
      await this.adminService.amendRoomSchedule(
        room.dpsLocationId,
        +scheduleId,
        this.bodyToAmendScheduleRequest(req),
        user,
      )
  ...
  private bodyToAmendScheduleRequest = (req: Request): AmendRoomScheduleRequest => {
    const {
      scheduleStartDay,
      scheduleEndDay,
      allDay,
  ...
  private convertScheduleToDisplayFormat = (schedule: RoomSchedule) => {
