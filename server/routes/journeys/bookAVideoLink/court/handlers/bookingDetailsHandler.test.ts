      ...
      return request(app)
        ...
        .then(() =>
          expectJourneySession(app, 'bookACourtHearing', {
            ...
            initialPreHearingStartTime: '1970-01-01T15:15:00.000Z',
            initialPreHearingEndTime: '1970-01-01T15:30:00.000Z',
            initialStartTime: '1970-01-01T15:30:00.000Z',
            initialEndTime: '1970-01-01T16:30:00.000Z',
            initialPostHearingStartTime: '1970-01-01T16:30:00.000Z',
            initialPostHearingEndTime: '1970-01-01T16:45:00.000Z',
            prisoner: {
              firstName: 'Joe',
              lastName: 'Smith',
              dateOfBirth: '1970-01-01',
