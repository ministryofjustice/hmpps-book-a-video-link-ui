...
export default class DeprecatedBookingNotAvailableHandler implements PageHandler {
  ...
  public GET = async (req: Request, res: Response) => {
    ...
    return res.render('pages/bookAVideoLink/court/notAvailableDeprecated', { alternatives })
  }
