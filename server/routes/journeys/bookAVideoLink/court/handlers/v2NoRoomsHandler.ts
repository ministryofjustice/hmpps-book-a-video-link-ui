...
export default class V2NoRoomsHandler implements PageHandler {
  public PAGE_NAME = Page.ALTERNATIVE_ROOMS_PAGE
  ...
  public GET = async (req: Request, res: Response) => {
    ...
    res.render('pages/bookAVideoLink/court/v2NoRooms', {
      prisoner: {
