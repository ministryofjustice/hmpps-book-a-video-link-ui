...
describe('Check Booking handler', () => {
  ...
  describe('GET', () => {
    it('should render the correct view page', () => {
      return request(app)
        .get(`/court/booking/create/${journeyId()}/A1234AA/add-video-link-booking/not-available`)
  ...
  describe('POST', () => {
    ...
    it('should validate no fields posted', () => {
      return request(app)
        .post(`/court/booking/create/${journeyId()}/A1234AA/add-video-link-booking/not-available`)
        .send({})
        .expect(() => {
          expectErrorMessages([
            {
